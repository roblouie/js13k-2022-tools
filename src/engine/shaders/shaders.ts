...
layout(location=0)in vec3 o;layout(location=1)in vec3 i;layout(location=2)in vec2 e;layout(location=3)in float n;uniform mat4 t;out vec2 v;out float c;out vec3 a;void main(){vec4 h=vec4(o,1.);gl_Position=t*h;v=e;c=n;a=i;gl_PointSize=6.0;}`
